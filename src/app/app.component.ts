...
const NAME_POOL: NamePoolItem[] = [
  { char: '安', meaning: '平安稳健', tags: ['health', 'steady'], gender: 'neutral' },
  { char: '宁', meaning: '安宁从容', tags: ['steady'], gender: 'neutral' },
  { char: '宸', meaning: '乾象高远', tags: ['noble'], gender: 'male' },
  { char: '辰', meaning: '星辰守护', tags: ['fortune'], gender: 'male' },
  { char: '睿', meaning: '聪慧敏锐', tags: ['wisdom'], gender: 'male' },
  { char: '澄', meaning: '清澈明朗', tags: ['mind'], gender: 'neutral' },
  { char: '煦', meaning: '温暖向阳', tags: ['warm'], gender: 'female' },
  { char: '泽', meaning: '润泽有福', tags: ['fortune'], gender: 'neutral' },
  { char: '瑾', meaning: '美玉光华', tags: ['noble'], gender: 'female' },
  { char: '熙', meaning: '兴盛光明', tags: ['fortune'], gender: 'neutral' },
  { char: '彦', meaning: '才德出众', tags: ['talent'], gender: 'male' },
  { char: '恒', meaning: '恒心坚韧', tags: ['steady'], gender: 'male' },
  { char: '朗', meaning: '明朗正气', tags: ['mind'], gender: 'male' },
  { char: '怡', meaning: '和悦安然', tags: ['warm'], gender: 'female' },
  { char: '雅', meaning: '雅正端庄', tags: ['noble'], gender: 'female' },
  { char: '嘉', meaning: '嘉许祥瑞', tags: ['fortune'], gender: 'neutral' },
  { char: '祺', meaning: '吉庆福气', tags: ['fortune'], gender: 'neutral' },
  { char: '昕', meaning: '晨光初升', tags: ['hope'], gender: 'neutral' },
  { char: '昊', meaning: '广阔高远', tags: ['noble'], gender: 'male' },
  { char: '芊', meaning: '草木茂盛', tags: ['growth'], gender: 'female' },
  { char: '沐', meaning: '沐风润泽', tags: ['warm'], gender: 'neutral' },
  { char: '澜', meaning: '波澜壮阔', tags: ['steady'], gender: 'male' },
  { char: '沅', meaning: '清流润物', tags: ['mind'], gender: 'neutral' },
  { char: '泓', meaning: '深水澄明', tags: ['mind'], gender: 'neutral' },
  { char: '沛', meaning: '沛然生发', tags: ['growth'], gender: 'neutral' },
  { char: '洵', meaning: '清澈可信', tags: ['steady'], gender: 'neutral' },
  { char: '泠', meaning: '清冷澄净', tags: ['mind'], gender: 'female' },
  { char: '涵', meaning: '涵养内敛', tags: ['steady'], gender: 'neutral' },
  { char: '渊', meaning: '深远有度', tags: ['noble'], gender: 'male' },
  { char: '渝', meaning: '恒心不移', tags: ['steady'], gender: 'neutral' },
  { char: '澈', meaning: '澄澈通透', tags: ['mind'], gender: 'neutral' },
  { char: '清', meaning: '清朗自持', tags: ['mind'], gender: 'neutral' },
  { char: '漪', meaning: '微澜柔和', tags: ['warm'], gender: 'female' },
  { char: '漾', meaning: '波光盈动', tags: ['hope'], gender: 'female' },
  { char: '潺', meaning: '潺潺生机', tags: ['growth'], gender: 'neutral' },
  { char: '汐', meaning: '潮汐有信', tags: ['steady'], gender: 'female' },
  { char: '潇', meaning: '潇然清朗', tags: ['mind'], gender: 'neutral' },
  { char: '溪', meaning: '溪流自在', tags: ['mind'], gender: 'neutral' },
  { char: '泉', meaning: '泉涌不息', tags: ['growth'], gender: 'neutral' },
  { char: '江', meaning: '江阔有度', tags: ['steady'], gender: 'male' },
  { char: '河', meaning: '河泽润民', tags: ['fortune'], gender: 'neutral' },
  { char: '海', meaning: '海纳百川', tags: ['noble'], gender: 'male' },
  { char: '湖', meaning: '湖光静美', tags: ['warm'], gender: 'female' },
  { char: '潮', meaning: '潮涌向前', tags: ['hope'], gender: 'male' },
  { char: '涛', meaning: '涛声壮阔', tags: ['talent'], gender: 'male' },
  { char: '淼', meaning: '水势浩渺', tags: ['fortune'], gender: 'neutral' },
  { char: '沧', meaning: '沧海自持', tags: ['steady'], gender: 'male' },
  { char: '溟', meaning: '溟濛深远', tags: ['noble'], gender: 'male' },
  { char: '渺', meaning: '渺然高致', tags: ['mind'], gender: 'neutral' },
  { char: '澍', meaning: '甘霖润泽', tags: ['fortune'], gender: 'neutral' },
  { char: '霖', meaning: '久雨滋养', tags: ['health'], gender: 'neutral' },
  { char: '霁', meaning: '雨霁天清', tags: ['hope'], gender: 'neutral' },
  { char: '霏', meaning: '霏霏轻柔', tags: ['warm'], gender: 'female' },
  { char: '霄', meaning: '凌霄高远', tags: ['noble'], gender: 'male' },
  { char: '霓', meaning: '霓光绚丽', tags: ['hope'], gender: 'female' },
  { char: '霞', meaning: '霞彩明艳', tags: ['warm'], gender: 'female' },
  { char: '霜', meaning: '霜洁自持', tags: ['steady'], gender: 'neutral' },
  { char: '雪', meaning: '雪净高洁', tags: ['noble'], gender: 'female' },
  { char: '露', meaning: '晨露清新', tags: ['mind'], gender: 'female' },
  { char: '雨', meaning: '甘雨润物', tags: ['health'], gender: 'female' },
  { char: '云', meaning: '云舒自在', tags: ['mind'], gender: 'neutral' },
  { char: '霭', meaning: '霭霭和煦', tags: ['warm'], gender: 'neutral' },
  { char: '雯', meaning: '云纹秀雅', tags: ['noble'], gender: 'female' },
  { char: '风', meaning: '清风自来', tags: ['hope'], gender: 'neutral' },
  { char: '岚', meaning: '岚气清润', tags: ['warm'], gender: 'female' },
  { char: '岑', meaning: '山岑稳重', tags: ['steady'], gender: 'male' },
  { char: '峰', meaning: '峰峦卓立', tags: ['noble'], gender: 'male' },
  { char: '峻', meaning: '峻拔有度', tags: ['talent'], gender: 'male' },
  { char: '嵘', meaning: '峥嵘不凡', tags: ['noble'], gender: 'male' },
  { char: '岩', meaning: '岩石坚稳', tags: ['steady'], gender: 'male' },
  { char: '峙', meaning: '峙立如山', tags: ['steady'], gender: 'male' },
  { char: '屿', meaning: '海屿清雅', tags: ['mind'], gender: 'neutral' },
  { char: '岫', meaning: '云岫幽雅', tags: ['noble'], gender: 'female' },
  { char: '岭', meaning: '山岭连绵', tags: ['steady'], gender: 'neutral' },
  { char: '岳', meaning: '岳立中正', tags: ['noble'], gender: 'male' },
  { char: '嵩', meaning: '嵩高自持', tags: ['noble'], gender: 'male' },
  { char: '岱', meaning: '岱宗稳重', tags: ['steady'], gender: 'male' },
  { char: '原', meaning: '原野开阔', tags: ['hope'], gender: 'neutral' },
  { char: '野', meaning: '野趣自在', tags: ['hope'], gender: 'neutral' },
  { char: '林', meaning: '林木繁茂', tags: ['growth'], gender: 'neutral' },
  { char: '森', meaning: '森然成势', tags: ['steady'], gender: 'male' },
  { char: '松', meaning: '松柏坚韧', tags: ['steady'], gender: 'male' },
  { char: '柏', meaning: '柏木坚贞', tags: ['steady'], gender: 'male' },
  { char: '杉', meaning: '杉影清直', tags: ['mind'], gender: 'neutral' },
  { char: '桐', meaning: '梧桐高洁', tags: ['noble'], gender: 'neutral' },
  { char: '梧', meaning: '梧影和鸣', tags: ['noble'], gender: 'neutral' },
  { char: '槐', meaning: '槐荫厚重', tags: ['steady'], gender: 'male' },
  { char: '榕', meaning: '榕影安和', tags: ['warm'], gender: 'neutral' },
  { char: '槿', meaning: '木槿清雅', tags: ['noble'], gender: 'female' },
  { char: '柳', meaning: '柳影轻柔', tags: ['warm'], gender: 'female' },
  { char: '桃', meaning: '桃华明媚', tags: ['fortune'], gender: 'female' },
  { char: '杏', meaning: '杏林雅致', tags: ['noble'], gender: 'female' },
  { char: '梨', meaning: '梨雪清润', tags: ['mind'], gender: 'female' },
  { char: '梅', meaning: '梅骨清雅', tags: ['noble'], gender: 'female' },
  { char: '兰', meaning: '兰心雅韵', tags: ['noble'], gender: 'female' },
  { char: '荷', meaning: '荷风清远', tags: ['warm'], gender: 'female' },
  { char: '莲', meaning: '莲净自持', tags: ['noble'], gender: 'female' },
  { char: '竹', meaning: '修竹有节', tags: ['steady'], gender: 'neutral' },
  { char: '芷', meaning: '白芷清香', tags: ['warm'], gender: 'female' },
  { char: '芙', meaning: '芙蓉雅致', tags: ['noble'], gender: 'female' },
  { char: '芳', meaning: '芳华自盛', tags: ['hope'], gender: 'female' },
  { char: '若', meaning: '若水含章', tags: ['mind'], gender: 'neutral' },
  { char: '芃', meaning: '芃芃生机', tags: ['growth'], gender: 'neutral' },
  { char: '苒', meaning: '苒苒温润', tags: ['warm'], gender: 'female' },
  { char: '苇', meaning: '芦苇柔韧', tags: ['steady'], gender: 'neutral' },
  { char: '芦', meaning: '芦影清韵', tags: ['mind'], gender: 'neutral' },
  { char: '蓉', meaning: '芙蓉清秀', tags: ['noble'], gender: 'female' },
  { char: '萱', meaning: '萱草安宁', tags: ['warm'], gender: 'female' },
  { char: '葵', meaning: '向阳而生', tags: ['hope'], gender: 'neutral' },
  { char: '菁', meaning: '菁华秀丽', tags: ['talent'], gender: 'female' },
  { char: '菀', meaning: '菀然柔美', tags: ['warm'], gender: 'female' },
  { char: '菡', meaning: '菡萏清雅', tags: ['noble'], gender: 'female' },
  { char: '茉', meaning: '茉香清新', tags: ['warm'], gender: 'female' },
  { char: '茵', meaning: '芳茵舒展', tags: ['growth'], gender: 'female' },
  { char: '莎', meaning: '莎草柔韧', tags: ['steady'], gender: 'female' },
  { char: '蕊', meaning: '花蕊灵秀', tags: ['hope'], gender: 'female' },
  { char: '薇', meaning: '紫薇雅致', tags: ['noble'], gender: 'female' },
  { char: '蕾', meaning: '花蕾新生', tags: ['growth'], gender: 'female' },
  { char: '萤', meaning: '萤光微明', tags: ['hope'], gender: 'female' },
  { char: '日', meaning: '旭日向阳', tags: ['hope'], gender: 'neutral' },
  { char: '月', meaning: '月华清朗', tags: ['mind'], gender: 'neutral' },
  { char: '旭', meaning: '旭日东升', tags: ['hope'], gender: 'male' },
  { char: '昱', meaning: '日光明耀', tags: ['talent'], gender: 'male' },
  { char: '晗', meaning: '晨光初照', tags: ['hope'], gender: 'neutral' },
  { char: '晴', meaning: '晴空明净', tags: ['mind'], gender: 'female' },
  { char: '曦', meaning: '朝曦朗照', tags: ['hope'], gender: 'male' },
  { char: '晟', meaning: '光盛兴旺', tags: ['fortune'], gender: 'male' },
  { char: '景', meaning: '景明和畅', tags: ['mind'], gender: 'neutral' },
  { char: '明', meaning: '明朗端正', tags: ['wisdom'], gender: 'neutral' },
  { char: '星', meaning: '星河璀璨', tags: ['hope'], gender: 'neutral' },
  { char: '曜', meaning: '曜曜生辉', tags: ['noble'], gender: 'male' },
  { char: '皓', meaning: '皓月清朗', tags: ['noble'], gender: 'male' },
  { char: '晨', meaning: '晨露初晴', tags: ['hope'], gender: 'neutral' },
  { char: '晔', meaning: '晔然明亮', tags: ['talent'], gender: 'male' },
  { char: '霆', meaning: '雷霆果决', tags: ['talent'], gender: 'male' },
  { char: '霈', meaning: '霈泽充盈', tags: ['fortune'], gender: 'neutral' },
  { char: '岸', meaning: '岸然自持', tags: ['steady'], gender: 'male' },
  { char: '洲', meaning: '水洲安然', tags: ['steady'], gender: 'neutral' },
  { char: '屹', meaning: '屹然不动', tags: ['steady'], gender: 'male' },
  { char: '鹤', meaning: '鹤姿高雅', tags: ['noble'], gender: 'neutral' },
  { char: '鹭', meaning: '白鹭清逸', tags: ['mind'], gender: 'female' },
  { char: '鹿', meaning: '鹿鸣祥和', tags: ['fortune'], gender: 'neutral' },
  { char: '鸿', meaning: '鸿鹄志远', tags: ['talent'], gender: 'male' },
  { char: '鲲', meaning: '鲲鹏之志', tags: ['noble'], gender: 'male' },
  { char: '鲤', meaning: '鲤跃向上', tags: ['hope'], gender: 'neutral' },
  // 2026 name list additions
  { char: '一', meaning: '简洁领航', tags: ['hope'], gender: 'neutral' },
  { char: '世', meaning: '大千世界', tags: ['talent'], gender: 'male' },
  { char: '丹', meaning: '丹明雅致', tags: ['warm'], gender: 'female' },
  { char: '书', meaning: '儒雅风范', tags: ['talent'], gender: 'male' },
  { char: '乾', meaning: '深邃浩远', tags: ['talent'], gender: 'male' },
  { char: '亦', meaning: '兼容并蓄', tags: ['talent'], gender: 'male' },
  { char: '仙', meaning: '清雅飘逸', tags: ['warm'], gender: 'female' },
  { char: '以', meaning: '蓄以成器', tags: ['talent'], gender: 'male' },
  { char: '任', meaning: '力量担当', tags: ['talent'], gender: 'male' },
  { char: '伊', meaning: '温婉柔和', tags: ['warm'], gender: 'female' },
  { char: '优', meaning: '佳绩卓越', tags: ['talent'], gender: 'male' },
  { char: '传', meaning: '传承有序', tags: ['talent'], gender: 'male' },
  { char: '伦', meaning: '人伦风范', tags: ['talent'], gender: 'male' },
  { char: '伯', meaning: '伯乐在世', tags: ['talent'], gender: 'male' },
  { char: '伽', meaning: '梵香伽蓝', tags: ['talent'], gender: 'male' },
  { char: '佳', meaning: '优雅俱备', tags: ['warm'], gender: 'female' },
  { char: '依', meaning: '小鸟依人', tags: ['warm'], gender: 'female' },
  { char: '修', meaning: '挺拔俊秀', tags: ['talent'], gender: 'male' },
  { char: '倩', meaning: '倩影翩翩', tags: ['warm'], gender: 'female' },
  { char: '其', meaning: '正逢其时', tags: ['talent'], gender: 'male' },
  { char: '冠', meaning: '领衔群雄', tags: ['talent'], gender: 'male' },
  { char: '凌', meaning: '高瞻远瞩', tags: ['talent'], gender: 'male' },
  { char: '凯', meaning: '一路凯旋', tags: ['talent'], gender: 'male' },
  { char: '千', meaning: '千姿百态', tags: ['talent'], gender: 'male' },
  { char: '南', meaning: '阳光温和', tags: ['talent'], gender: 'male' },
  { char: '卿', meaning: '雅致清新', tags: ['hope'], gender: 'neutral' },
  { char: '可', meaning: '得以应手', tags: ['warm'], gender: 'female' },
  { char: '君', meaning: '儒雅风范', tags: ['talent'], gender: 'male' },
  { char: '含', meaning: '温婉柔美', tags: ['warm'], gender: 'female' },
  { char: '哲', meaning: '聪慧过人', tags: ['talent'], gender: 'male' },
  { char: '唯', meaning: '专注致远', tags: ['talent'], gender: 'male' },
  { char: '图', meaning: '目标明确', tags: ['talent'], gender: 'male' },
  { char: '圣', meaning: '德高望重', tags: ['talent'], gender: 'male' },
  { char: '城', meaning: '坚如磐石', tags: ['talent'], gender: 'male' },
  { char: '奕', meaning: '神采奕奕', tags: ['warm'], gender: 'female' },
  { char: '妍', meaning: '娇妍温婉', tags: ['warm'], gender: 'female' },
  { char: '妤', meaning: '慧美兼具', tags: ['warm'], gender: 'female' },
  { char: '姗', meaning: '清雅温婉', tags: ['warm'], gender: 'female' },
  { char: '姝', meaning: '美若天仙', tags: ['warm'], gender: 'female' },
  { char: '娅', meaning: '娇娆妩媚', tags: ['warm'], gender: 'female' },
  { char: '娜', meaning: '婀娜多姿', tags: ['warm'], gender: 'female' },
  { char: '娴', meaning: '温婉贤淑', tags: ['warm'], gender: 'female' },
  { char: '婉', meaning: '温婉柔美', tags: ['warm'], gender: 'female' },
  { char: '婧', meaning: '秀外慧中', tags: ['warm'], gender: 'female' },
  { char: '媛', meaning: '温婉贤淑', tags: ['warm'], gender: 'female' },
  { char: '嫣', meaning: '妍丽动人', tags: ['warm'], gender: 'female' },
  { char: '子', meaning: '儒雅风范', tags: ['hope'], gender: 'neutral' },
  { char: '学', meaning: '儒雅气质', tags: ['talent'], gender: 'male' },
  { char: '宇', meaning: '气宇轩昂', tags: ['talent'], gender: 'male' },
  { char: '宗', meaning: '传承千秋', tags: ['talent'], gender: 'male' },
  { char: '富', meaning: '丰富厚重', tags: ['talent'], gender: 'male' },
  { char: '寒', meaning: '峻拔刚毅', tags: ['talent'], gender: 'male' },
  { char: '封', meaning: '丰厚稳固', tags: ['talent'], gender: 'male' },
  { char: '尹', meaning: '有力有序', tags: ['warm'], gender: 'female' },
  { char: '展', meaning: '大展宏图', tags: ['talent'], gender: 'male' },
  { char: '左', meaning: '助力成长', tags: ['talent'], gender: 'male' },
  { char: '帆', meaning: '一帆风顺', tags: ['talent'], gender: 'male' },
  { char: '希', meaning: '希望之光', tags: ['warm'], gender: 'female' },
  { char: '庭', meaning: '风华正茂', tags: ['talent'], gender: 'male' },
  { char: '延', meaning: '绵延不绝', tags: ['talent'], gender: 'male' },
  { char: '归', meaning: '功成名就', tags: ['talent'], gender: 'male' },
  { char: '彩', meaning: '五彩缤纷', tags: ['warm'], gender: 'female' },
  { char: '彬', meaning: '彬彬有礼', tags: ['talent'], gender: 'male' },
  { char: '征', meaning: '一往无前', tags: ['talent'], gender: 'male' },
  { char: '忆', meaning: '念念不忘', tags: ['talent'], gender: 'male' },
  { char: '志', meaning: '志存高远', tags: ['talent'], gender: 'male' },
  { char: '恬', meaning: '恬静安宁', tags: ['warm'], gender: 'female' },
  { char: '恺', meaning: '快乐安康', tags: ['talent'], gender: 'male' },
  { char: '慧', meaning: '聪慧过人', tags: ['warm'], gender: 'female' },
  { char: '政', meaning: '政通人和', tags: ['talent'], gender: 'male' },
  { char: '文', meaning: '文质彬彬', tags: ['talent'], gender: 'male' },
  { char: '旎', meaning: '妍丽动人', tags: ['warm'], gender: 'female' },
  { char: '旗', meaning: '旗开得胜', tags: ['talent'], gender: 'male' },
  { char: '时', meaning: '洞察先机', tags: ['talent'], gender: 'male' },
  { char: '晋', meaning: '步步高升', tags: ['talent'], gender: 'male' },
  { char: '晚', meaning: '温柔贤淑', tags: ['warm'], gender: 'female' },
  { char: '普', meaning: '天地同辉', tags: ['talent'], gender: 'male' },
  { char: '晶', meaning: '晶莹剔透', tags: ['talent'], gender: 'male' },
  { char: '暖', meaning: '温暖如春', tags: ['warm'], gender: 'female' },
  { char: '曼', meaning: '婀娜多姿', tags: ['warm'], gender: 'female' },
  { char: '朝', meaning: '朝气蓬勃', tags: ['talent'], gender: 'male' },
  { char: '期', meaning: '成功在望', tags: ['talent'], gender: 'male' },
  { char: '朵', meaning: '花团锦簇', tags: ['warm'], gender: 'female' },
  { char: '材', meaning: '栋梁之才', tags: ['talent'], gender: 'male' },
  { char: '杭', meaning: '航程万里', tags: ['talent'], gender: 'male' },
  { char: '杰', meaning: '出类拔萃', tags: ['talent'], gender: 'male' },
  { char: '枫', meaning: '枫叶如丹', tags: ['talent'], gender: 'male' },
  { char: '柔', meaning: '温柔贤淑', tags: ['warm'], gender: 'female' },
  { char: '格', meaning: '人品端正', tags: ['talent'], gender: 'male' },
  { char: '梓', meaning: '茁壮成长', tags: ['talent'], gender: 'male' },
  { char: '梦', meaning: '美梦成真', tags: ['warm'], gender: 'female' },
  { char: '欣', meaning: '欣欣向荣', tags: ['warm'], gender: 'female' },
  { char: '欧', meaning: '修养深厚', tags: ['talent'], gender: 'male' },
  { char: '毅', meaning: '坚毅果断', tags: ['talent'], gender: 'male' },
  { char: '汇', meaning: '汇聚力量', tags: ['talent'], gender: 'male' },
  { char: '洋', meaning: '波澜壮阔', tags: ['talent'], gender: 'male' },
  { char: '洛', meaning: '繁华丰盛', tags: ['warm'], gender: 'female' },
  { char: '津', meaning: '天涯通途', tags: ['talent'], gender: 'male' },
  { char: '浅', meaning: '优雅从容', tags: ['warm'], gender: 'female' },
  { char: '润', meaning: '滋润万物', tags: ['talent'], gender: 'male' },
  { char: '淇', meaning: '清雅温婉', tags: ['warm'], gender: 'female' },
  { char: '淑', meaning: '温柔贤淑', tags: ['warm'], gender: 'female' },
  { char: '溥', meaning: '广阔无垠', tags: ['talent'], gender: 'male' },
  { char: '滢', meaning: '晶莹剔透', tags: ['warm'], gender: 'female' },
  { char: '炎', meaning: '炽热奔放', tags: ['talent'], gender: 'male' },
  { char: '焱', meaning: '光辉灿烂', tags: ['talent'], gender: 'male' },
  { char: '玮', meaning: '精美珍奇', tags: ['talent'], gender: 'male' },
  { char: '珀', meaning: '珍贵美玉', tags: ['talent'], gender: 'male' },
  { char: '珊', meaning: '优雅从容', tags: ['warm'], gender: 'female' },
  { char: '珲', meaning: '珍贵美玉', tags: ['talent'], gender: 'male' },
  { char: '琪', meaning: '琪花瑶草', tags: ['warm'], gender: 'female' },
  { char: '琬', meaning: '温柔贤淑', tags: ['warm'], gender: 'female' },
  { char: '琼', meaning: '美玉无瑕', tags: ['warm'], gender: 'female' },
  { char: '瑗', meaning: '纯洁尊贵', tags: ['warm'], gender: 'female' },
  { char: '瑛', meaning: '晶莹剔透', tags: ['warm'], gender: 'female' },
  { char: '瑞', meaning: '吉祥如意', tags: ['talent'], gender: 'male' },
  { char: '璐', meaning: '美玉无瑕', tags: ['warm'], gender: 'female' },
  { char: '盈', meaning: '盈盈仙致', tags: ['warm'], gender: 'female' },
  { char: '益', meaning: '友爱盈益', tags: ['talent'], gender: 'male' },
  { char: '盛', meaning: '繁荣昌盛', tags: ['talent'], gender: 'male' },
  { char: '知', meaning: '学丰知广', tags: ['talent'], gender: 'male' },
  { char: '祯', meaning: '吉祥如意', tags: ['warm'], gender: 'female' },
  { char: '竣', meaning: '俊秀挺拔', tags: ['talent'], gender: 'male' },
  { char: '纬', meaning: '经纬万端', tags: ['talent'], gender: 'male' },
  { char: '纯', meaning: '纯洁无瑕', tags: ['talent'], gender: 'male' },
  { char: '绎', meaning: '精致有序', tags: ['talent'], gender: 'male' },
  { char: '绮', meaning: '美丽华贵', tags: ['warm'], gender: 'female' },
  { char: '绰', meaning: '丰富有余', tags: ['talent'], gender: 'male' },
  { char: '维', meaning: '持久有序', tags: ['talent'], gender: 'male' },
  { char: '美', meaning: '美丽华贵', tags: ['warm'], gender: 'female' },
  { char: '羲', meaning: '太阳之光', tags: ['warm'], gender: 'female' },
  { char: '羽', meaning: '翱翔高飞', tags: ['talent'], gender: 'male' },
  { char: '翌', meaning: '崭新岁月', tags: ['talent'], gender: 'male' },
  { char: '翎', meaning: '羽毛华美', tags: ['talent'], gender: 'male' },
  { char: '耀', meaning: '光辉灿烂', tags: ['talent'], gender: 'male' },
  { char: '航', meaning: '航行远方', tags: ['talent'], gender: 'male' },
  { char: '艺', meaning: '多才多艺', tags: ['warm'], gender: 'female' },
  { char: '芝', meaning: '美丽华贵', tags: ['warm'], gender: 'female' },
  { char: '芮', meaning: '细柔嫩美', tags: ['warm'], gender: 'female' },
  { char: '芯', meaning: '细腻柔软', tags: ['warm'], gender: 'female' },
  { char: '芸', meaning: '美丽淤清香', tags: ['warm'], gender: 'female' },
  { char: '芹', meaning: '才学勤丰', tags: ['warm'], gender: 'female' },
  { char: '茜', meaning: '红艳如火', tags: ['warm'], gender: 'female' },
  { char: '菲', meaning: '绵延芬芳', tags: ['warm'], gender: 'female' },
  { char: '萁', meaning: '纤纤细秀', tags: ['warm'], gender: 'female' },
  { char: '萌', meaning: '可爱萌动', tags: ['warm'], gender: 'female' },
  { char: '蒙', meaning: '蒙蒙清新', tags: ['warm'], gender: 'female' },
  { char: '蓓', meaning: '蓓蕾初绽', tags: ['warm'], gender: 'female' },
  { char: '蓝', meaning: '湛蓝如海', tags: ['talent'], gender: 'male' },
  { char: '蔓', meaning: '蔓妙佳宜', tags: ['warm'], gender: 'female' },
  { char: '蕙', meaning: '蕙质兰心', tags: ['warm'], gender: 'female' },
  { char: '薰', meaning: '薰风拂面', tags: ['warm'], gender: 'female' },
  { char: '衣', meaning: '时尚优雅', tags: ['hope'], gender: 'neutral' },
  { char: '言', meaning: '美妙动听', tags: ['talent'], gender: 'male' },
  { char: '训', meaning: '谆谆教诲', tags: ['talent'], gender: 'male' },
  { char: '讯', meaning: '信息传递', tags: ['talent'], gender: 'male' },
  { char: '诗', meaning: '高雅诗意', tags: ['warm'], gender: 'female' },
  { char: '诚', meaning: '精诚所至', tags: ['talent'], gender: 'male' },
  { char: '语', meaning: '娓娓动听', tags: ['warm'], gender: 'female' },
  { char: '豪', meaning: '豪迈英姿', tags: ['talent'], gender: 'male' },
  { char: '贵', meaning: '尊贵荣耀', tags: ['talent'], gender: 'male' },
  { char: '越', meaning: '超越卓越', tags: ['talent'], gender: 'male' },
  { char: '轲', meaning: '行远志高', tags: ['warm'], gender: 'female' },
  { char: '辉', meaning: '光辉灿烂', tags: ['talent'], gender: 'male' },
  { char: '迅', meaning: '迅捷敏锐', tags: ['warm'], gender: 'female' },
  { char: '运', meaning: '运筹帷幄', tags: ['talent'], gender: 'male' },
  { char: '逍', meaning: '逍遥自在', tags: ['talent'], gender: 'male' },
  { char: '遥', meaning: '遥远广阔', tags: ['warm'], gender: 'female' },
  { char: '邦', meaning: '国家安宁', tags: ['talent'], gender: 'male' },
  { char: '钰', meaning: '珍贵宝玉', tags: ['warm'], gender: 'female' },
  { char: '铠', meaning: '铠甲坚固', tags: ['talent'], gender: 'male' },
  { char: '铭', meaning: '铭记不忘', tags: ['talent'], gender: 'male' },
  { char: '问', meaning: '询问探求', tags: ['talent'], gender: 'male' },
  { char: '阳', meaning: '阳光明媚', tags: ['talent'], gender: 'male' },
  { char: '青', meaning: '青春焕发', tags: ['warm'], gender: 'female' },
  { char: '非', meaning: '非凡卓越', tags: ['talent'], gender: 'male' },
  { char: '韵', meaning: '韵味悠长', tags: ['warm'], gender: 'female' },
  { char: '韶', meaning: '韶华正茂', tags: ['talent'], gender: 'male' },
  { char: '项', meaning: '志存高远', tags: ['talent'], gender: 'male' },
  { char: '顺', meaning: '顺遂安康', tags: ['talent'], gender: 'male' },
  { char: '颀', meaning: '颀长挺拔', tags: ['talent'], gender: 'male' },
  { char: '颖', meaning: '聪颖过人', tags: ['warm'], gender: 'female' },
  { char: '首', meaning: '首屈一指', tags: ['talent'], gender: 'male' },
  { char: '驰', meaning: '纵横驰骋', tags: ['talent'], gender: 'male' },
  { char: '骁', meaning: '骁勇善战', tags: ['talent'], gender: 'male' },
  { char: '骏', meaning: '骏马奔腾', tags: ['talent'], gender: 'male' },
  { char: '默', meaning: '深邃沉静', tags: ['talent'], gender: 'male' },
  { char: '鼎', meaning: '鼎立天地', tags: ['talent'], gender: 'male' },
  { char: '宥', meaning: '宽厚仁爱', tags: ['warm'], gender: 'neutral' },
  { char: '祐', meaning: '护佑安宁', tags: ['fortune'], gender: 'neutral' },
  { char: '承', meaning: '承载担当', tags: ['steady'], gender: 'male' },
...
export class AppComponent {
  ...
  private isNameGenderMatch(itemGender: NameGender, gender: Gender): boolean {
    return itemGender === 'neutral' || itemGender === gender;
  }
